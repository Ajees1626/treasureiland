        ...
        <div className="grid gap-10 lg:grid-cols-2 lg:items-center lg:gap-16">
          ...
          >
            <img
              ...
              loading="lazy"
            />
            <div className="absolute inset-0 bg-linear-to-t from-[#2457A7]/40 to-transparent" />
          </motion.div>
          <motion.div
            initial={{ opacity: 0, x: 20 }}
            whileInView={{ opacity: 1, x: 0 }}
          ...
          >
            ...
            <div className="mt-8 space-y-4">
              <div className="flex items-center gap-3 text-gray-700">
                <HiClock className="h-5 w-5 shrink-0 text-[#2457A7]" />
                <span><strong>Visiting hours:</strong> Mon – Sat, 9:00 AM – 4:00 PM (prior appointment preferred)</span>
              </div>
              <div className="flex items-center gap-3 text-gray-700">
                <HiPhone className="h-5 w-5 shrink-0 text-[#2457A7]" />
            ...
            <Link
              to="/contact"
              className="mt-8 inline-flex items-center gap-2 rounded-full bg-[#2457A7] px-6 py-3.5 font-semibold text-white shadow-lg transition hover:bg-[#1B93D1]"
            >
              Book Campus Tour
            </Link>
          </motion.div>
