  ...
  return (
    <section className="relative overflow-hidden py-16 sm:py-20">
      ...
      <div className="relative z-10 mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
        ...
        >
          Join a community where teaching methodology meets care, discipline, and growth.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <Link
            to="/contact"
            className="inline-flex items-center rounded-full border-2 border-white/90 px-8 py-4 text-base font-semibold text-white transition hover:bg-white/20"
          >
            Enquire Admission
          </Link>
        </motion.div>
